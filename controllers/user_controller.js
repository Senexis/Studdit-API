...
module.exports ={
    ...
    updatePassword(req, res, next) {
      const params = { username: req.params.username, password: req.body.password, newPassword: req.body.newPassword}
      console.log(params);
    ...
    delete(req, res, next) {
      const params = { username: req.params.username, password: req.body.password }
      console.log(params);
      if(params.username === undefined || params.password === undefined) {
        res.status(409).json("Please enter all required fields");
      }
